...
#initialize the array of authors
...
#Construction of the matrix of confusion
if (open FSRC, "<Result_Lexical_Frequencies.txt")
{  
  if(open FDST, ">CrossValidation_Lexical_Frequencies.csv")
  {
		@lignes=<FSRC>;
		$true_author=0;
		$other_author=0;
